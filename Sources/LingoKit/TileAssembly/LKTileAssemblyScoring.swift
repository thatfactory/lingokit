...
/// Scoring policy for tile-assembly exercises.
public struct LKTileAssemblyScoring: Codable, Sendable, Equatable {
    /// Score awarded when the selected tile sequence is correct.
    public let correctPoints: Int
    /// Score awarded when the selected tile sequence is incorrect.
    ...
    public static let standard = LKTileAssemblyScoring(
        correctPoints: 10,
        incorrectPoints: 0
    )
}
